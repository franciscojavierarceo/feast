...
Feast (**Fea**ture **St**ore) is an open source feature store for machine learning. Feast serves different user types:

* **Data Scientists & ML Engineers**: Focus on feature engineering and model development
* **MLOps Engineers**: Manage production ML infrastructure
* **Data Engineers**: Build and maintain data pipelines
* **Software Engineers**: Integrate ML features into applications

Choose your path to get started:
- [Data Scientist Guide](docs/user-guides/data-scientist-guide.md)
- [MLOps Engineer Guide](docs/user-guides/mlops-guide.md)
- [Data Engineer Guide](docs/user-guides/data-engineer-guide.md)
- [Software Engineer Guide](docs/user-guides/software-engineer-guide.md)
